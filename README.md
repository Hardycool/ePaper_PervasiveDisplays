 *  The example code is for PDi iTC EPD(1.54"/2.13"/2.66"/2.71"/2.87"/7.4") on EXT2 board, it's verified by Arduino M0 Pro.
 ...
 *  ![image](https://github.com/Hardy-PDi/ePaper_PervasiveDisplays/blob/master/arduino_EXT2.JPG)
